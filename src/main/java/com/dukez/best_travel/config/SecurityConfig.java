...
public class SecurityConfig {
    ...
    /**
     * 
     * Configura filtros de seguridad de la aplicación.
     *
     * @param http objeto de configuración de seguridad
     * @return filtros de seguridad configurados
     * @throws Exception
     */
    @Bean
    public SecurityFilterChain appSecurityFilterChain(HttpSecurity http) throws Exception {
        http.formLogin().and().authorizeHttpRequests().requestMatchers(PUBLIC_RESOURCES).permitAll()
                .requestMatchers(USER_RESOURCES).authenticated().requestMatchers(ADMIN_RESOURCES).hasRole(ADMIN_ROLE)
    ...
    public TokenSettings tokenSettings() {
        return TokenSettings.builder().refreshTokenTimeToLive(Duration.ofHours(8))
    ...
    private static final String APPLICATION_OWNER = "Prog Duke";
